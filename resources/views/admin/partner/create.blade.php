...
@section('content')
    <div class="col-span-5 row-span-3 bg-gray-200 p-6">
        <h2 class="text-2xl font-semibold mb-4">Create Partnery</h2>
        <form action="{{ route('admin.partners.store') }}" method="POST">
            @csrf
            <input type="hidden" name="role_id" value="2">
            <div class="mb-4">
                <label for="name" class="block text-gray-700 font-medium mb-2">Last Name</label>
                <input type="text" name="name" id="name" class="w-full border-gray-300 rounded-md px-4 py-2 focus:border-green-200 focus:outline-none" required>
            </div>
            <div class="mb-4">
